namespace GenShin_Launcher_Plus.Models
{
    public class LanguagesModel
    {
        ...
        public string TimeStatusUpdate { get; set; }
        public string TimeStatusCheck { get; set; }
        public string TimeStatusUnErr { get; set; }
        public string TimeStatusBaking { get; set; }
        public string TimeStatusReping { get; set; }
        public string TimeStatusRecover { get; set; }
        public string TimeStatusCleaning { get; set; }
        public string GameSwitchLogStr { get; set; }
